...
@Component({
  ...
  standalone: true,
  imports: [AnimatedRealmsComponent, UpgradeStreamsComponent, LevelUpStreamsComponent, Portfolio3DScenesComponent, StreamingCreativitySectionComponent, HeaderBannerComponent],
