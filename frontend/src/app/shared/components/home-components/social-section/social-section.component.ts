...
@Component({
  ...
  standalone: true,
  imports: [NgIf, NgFor, RouterLink, NgbTooltip, LazyLoadImageModule],
...
export class SocialSectionComponent implements OnInit {
  ...
  private getSocialSection(): void {
    this.socialSection = {
      ...
      "profileImageUrl": "favicon-darker.png",
      ...
      "postList": [
        {
          ...
          "placeholder": "images/post1-default.jpg"
        },
        {
          "id": 2,
          ...
          "placeholder": "images/post2-default.jpg"
        },
        {
          "id": 3,
          ...
          "placeholder": "images/post3-default.jpg"
        },
        {
          "id": 4,
          ...
          "placeholder": "images/post4-default.jpg"
        },
        {
          "id": 5,
          ...
          "placeholder": "images/post5-default.jpg"
        },
        {
          "id": 6,
          ...
          "placeholder": "images/post6-default.jpg"
        },
        {
          "id": 7,
          "imageUrl": "images/post7.jpg",
          ...
          "placeholder": "images/post7-default.jpg"
        },
        {
          "id": 8,
          "imageUrl": "images/post8.jpg",
          ...
          "placeholder": "images/post8-default.jpg"
        }
      ],
      "socialMediaLinks": [
        {
